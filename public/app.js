...
function renderHome() {
  ...
  return `
    ...
    <section class="section banner-row">
      <img src="/assets/unity-2026.png" alt="Информационный баннер 2026">
      <img src="/assets/ministry-news.png" alt="Новости Министерства просвещения">
    </section>
  `;
}
        ...
        <aside class="schedule-source">
          ${groups.map((group) => `
            <article class="card">
              ...
              ${group.ImagePath ? `<img class="source-image" src="${escapeHtml(group.ImagePath)}" alt="${escapeHtml(group.Title)}">` : ''}
            </article>
          `).join('')}
        </aside>
      </div>
    ...
    <section class="section">
      ...
      <div class="grid grid--2">
        ...
        <article class="card">
          ...
          <img class="source-image" src="/assets/map.png" alt="Карта проезда">
        </article>
      </div>
    </section>
